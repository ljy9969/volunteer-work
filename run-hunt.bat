...
REM Prune today lines from hunt.log before this cycle (keeps yesterday-and-earlier).
...
REM Holiday/blackout dates to skip (comma-separated yyyy-mm-dd). 06-06 Memorial Day, 06-13 and 06-27 user-blackout.
set EXCLUDE_DATES=2026-06-06,2026-06-13,2026-06-27
